# ============================================================
#  FreedomForge AI — ui/app_window.py
...
from ui.phone_tab   import PhonePanel
...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        self.phone_panel    = PhonePanel(self.content_frame, self, T)
        ...
        self.panels["Phone"]    = self.phone_panel
